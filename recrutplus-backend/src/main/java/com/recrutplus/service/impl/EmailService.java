...
public class EmailService {
  ...
  public void sendApplicationConfirmation(
      String candidatEmail, String candidatName, String offerTitle) {
    try {
  ...
  public void sendStatusChange(
    ...
    System.out.println(
        "Email changement statut envoyé à : " + candidatEmail + " - Statut : " + newStatus);
  }
    ...
    try {
      ...
      String content =
          String.format(
              ...
              interviewDate,
              interviewType,
              visioLink != null && !visioLink.isEmpty()
                  ? "- Lien visioconférence : " + visioLink
  ...
  public void sendNewApplicationNotification(
      String rhEmail, String candidatName, String offerTitle, Long applicationId) {
    try {
      MimeMessage message = mailSender.createMimeMessage();
      MimeMessageHelper helper = new MimeMessageHelper(message, true, "UTF-8");
    ...
    try {
      ...
      String content =
          String.format(
              ...
              interviewDate,
              offerTitle,
              reason != null ? reason : "Nous nous excusons pour ce contretemps.");
  ...
  public void sendTestEmail(String toEmail) {
    try {
      ...
      String content =
          "Ceci est un email de test pour vérifier la configuration de RecrutePlus.\n\n"
