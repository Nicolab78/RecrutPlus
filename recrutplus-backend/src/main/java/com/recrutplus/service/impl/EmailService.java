...
public class EmailService {
    ...
    public void sendStatusChange(String candidatEmail, String candidatName, String offerTitle, ApplicationStatus newStatus, String comment) throws MessagingException {
